...
public class BeerControllerTest {
    ...
    @Test
    void whenGETIsCalledWithoutRegisteredNameNotFoundStatusIsReturned() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETListWithoutBeersIsCalledThenOkStatusIsReturn() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
